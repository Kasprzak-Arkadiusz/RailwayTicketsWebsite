...
namespace WebUI.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            ExternalLoginInfo info = (ExternalLoginInfo)await _identityService.GetExternalLoginInfoAsync();
            if (info == null)
            {
            ...
            var result = await _identityService.ExternalLoginSignInAsync(info.LoginProvider, info.ProviderKey);
            if (result.Succeeded)
            {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    result = await _identityService.AddLoginAsync(user, info);
                    if (result.Result.Succeeded)
                    {
